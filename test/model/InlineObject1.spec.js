...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineObject1();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineObject1);
    });

    it('should have the property pin (base name: "pin")', function() {
      // uncomment below and update the code to test the property pin
      //var instance = new ModumMoDsenseApi.InlineObject1();
