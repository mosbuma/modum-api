...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instane = new ModumMoDsenseApi.ChangePasswordRequest();
      //expect(instance).to.be.a(ModumMoDsenseApi.ChangePasswordRequest);
    });
    ...
    it('should have the property currentPassword (base name: "current_password")', function() {
      ...
      //var instance = new ModumMoDsenseApi.ChangePasswordRequest();
