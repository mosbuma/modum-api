...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineObject2();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineObject2);
    });

    it('should have the property permissions (base name: "permissions")', function() {
      // uncomment below and update the code to test the property permissions
      //var instance = new ModumMoDsenseApi.InlineObject2();
