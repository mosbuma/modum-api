...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineResponse2003();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineResponse2003);
    });
    ...
    it('should have the property profileGroupId (base name: "profile_group_id")', function() {
      ...
      //var instance = new ModumMoDsenseApi.InlineResponse2003();
