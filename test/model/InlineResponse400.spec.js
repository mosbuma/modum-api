...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineResponse400();
  });
  ...
  describe('InlineResponse400', function() {
    it('should create an instance of InlineResponse400', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineResponse400();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineResponse400);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new ModumMoDsenseApi.InlineResponse400();
