...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.PutShipmentsRequest();
  });
  ...
  describe('PutShipmentsRequest', function() {
    it('should create an instance of PutShipmentsRequest', function() {
      // uncomment below and update the code to test PutShipmentsRequest
      //var instane = new ModumMoDsenseApi.PutShipmentsRequest();
      //expect(instance).to.be.a(ModumMoDsenseApi.PutShipmentsRequest);
    });
    ...
    it('should have the property trackingId (base name: "tracking_id")', function() {
      ...
      //var instance = new ModumMoDsenseApi.PutShipmentsRequest();
