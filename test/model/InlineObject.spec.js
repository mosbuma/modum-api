...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineObject();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineObject);
    });
    ...
    it('should have the property noncePrefix (base name: "nonce_prefix")', function() {
      ...
      //var instance = new ModumMoDsenseApi.InlineObject();
