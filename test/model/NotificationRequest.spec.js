...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.NotificationRequest();
  });
  ...
  describe('NotificationRequest', function() {
    it('should create an instance of NotificationRequest', function() {
      ...
      //var instane = new ModumMoDsenseApi.NotificationRequest();
      //expect(instance).to.be.a(ModumMoDsenseApi.NotificationRequest);
    });
    ...
    it('should have the property recipientId (base name: "recipient_id")', function() {
      ...
      //var instance = new ModumMoDsenseApi.NotificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property profileGroupId (base name: "profile_group_id")', function() {
      // uncomment below and update the code to test the property profileGroupId
      //var instance = new ModumMoDsenseApi.NotificationRequest();
      //expect(instance).to.be();
    });
