...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ModumMoDsenseApi.InlineResponse403();
  });
  ...
  describe('InlineResponse403', function() {
    it('should create an instance of InlineResponse403', function() {
      ...
      //var instane = new ModumMoDsenseApi.InlineResponse403();
      //expect(instance).to.be.a(ModumMoDsenseApi.InlineResponse403);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new ModumMoDsenseApi.InlineResponse403();
